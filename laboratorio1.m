...
figure3 = figure('Name', 'Función a(x) y b(x)');
...
figure4 = figure('Name', 'Función c(x)');
...
figure5 = figure('Name', 'Función c(x) - Logarítmica');
...
iterations = input('Ingrese la cantidad máxima de iteraciones: ');
tol = input('Ingrese la tolerancia del error (valores entre 0 y 1): ');
initial_value = input('Ingrese el valor inicial: ');

[root, error_obtained, remaining_iterations] = newton_rapshon(polynomial, ...
                                        iterations, tol, initial_value);
